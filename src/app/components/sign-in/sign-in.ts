        ...
        <div class="surface-ground px-4 py-8 md:px-6 lg:px-8 flex align-items-center justify-content-center min-h-screen">
            <div class="surface-card p-4 shadow-2 border-round-xl w-full" style="max-width: 400px;">
                ...
                <div class="flex flex-column align-items-center gap-4 mb-5">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4rem w-4rem" viewBox="0 0 33 32" fill="none">
                    ...
                    <div class="text-center">
                        ...
                        <a class="font-medium no-underline ml-2 text-blue-500 cursor-pointer">צור עכשיו!</a>
                    </div>
                </div>
                ...
                <div class="flex flex-column gap-3">
                    <div class="flex flex-column gap-2">
                        ...
                        <input pInputText id="email1" type="text" placeholder="הכנס דואל" class="w-full" />
                    </div>
                    
                    <div class="flex flex-column gap-2">
                        <label for="password1" class="block text-900 font-medium">סיסמה</label>
                        <input pInputText id="password1" type="password" placeholder="סיסמה" class="w-full" />
                    </div>
